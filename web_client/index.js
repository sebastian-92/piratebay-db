...
const OFFENSIVE_REGEXES = [
    ...
    const capitalizedRegex = new RegExp('([a-z0-9_])' + escapeRegex(capitalized) + '([A-Z0-9_])');
...
const halfPromise = urlToCsvTextPromise('https://tpbdbdata.cbass92.org/piratebay_db_dump_2015_10_27T04_10_50_to_2019_09_14T22_09_31.csv');
const secondPromise = halfPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/piratebay_db_dump_2004_03_25T22_03_00_to_2015_10_27T04_10_22.csv'));

const csvTextPromises = [
    urlToCsvTextPromise('https://tpbdbdata.cbass92.org/random_torrent_contributions.csv'),
    halfPromise,
    secondPromise,
    ...
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_2.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_8.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_9.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_10.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_11.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_18.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_19.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_20.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_22.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_23.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_24.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_25.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_26.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_28.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_29.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_31.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_33.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_34.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_35.csv',)),
    secondPromise.then(() => urlToCsvTextPromise('https://tpbdbdata.cbass92.org/rutracker_2020_09_27/category_37.csv',)),
];
...
const makeTorrentTr = (record) => {
    ...
    const streamLink = Dom('a', {
        'href': 'http://tpbdb.000.pe/player.php?infohash=' + infoHash
    }, [
        Dom('span', {'class': 'info-hash-text'}, "(stream here)")
    ]);

    const downloadLink = Dom('a', {
        'href': 'http://tpbdb.000.pe/dl.php?infohash=' + infoHash
    }, [
        Dom('span', {}, '(download)')
    ]);
